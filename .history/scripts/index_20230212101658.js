...
function calcTemp(){ 
    // Cálculo de celsius para fahrenheit 
       ...
       res.innerHTML = `${graus} Celsius em Fahrenheit é ${result}°F`
    }
        ...
        let graus = document.getElementById('graus');
         graus = Number(graus.value)
          const resultInt = (graus - 32) / 1.8;
            ...
            res.innerHTML = `${graus} Fahrenheit em Celsius é ${resultInt.toPrecision(4)}°C`
        }
        ...
        res.innerHTML = `${graus} Celsius em Kelvin é ${result} K`
       } 
       //Kelvin para Celsius
       ...
       // Kelvin para Fahrenheit
        ...
        res.innerHTML = `${graus} Fahrenheit em Kelvin é ${result.toPrecision(2)} K`
    } 
        else if(Number.isInteger(result) == false){
            res.innerHTML = `${graus} Kelvin em Fahrenheit é ${result.toPrecision(5)}°F `
        }
       } 
       //Fahrenheit para Kelvin
        ...
        if(Number.isInteger(result) == true){
        res.innerHTML = `${graus} Fahrenheit em Kelvin é ${result} K`
       }else if(Number.isInteger(result) == false){
        res.innerHTML = `${graus} Fahrenheit em Kelvin é ${result.toPrecision(6)} K`
       }
    }else{
        alert("Você selecionou duas escalas de temperaturas iguais")
        res.innerHTML = `Selecione duas escalas diferentes`
    }
